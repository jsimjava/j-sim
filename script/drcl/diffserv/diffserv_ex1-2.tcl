# diffserv_ex1-2.tcl
#
# same as diffserv_ex1.tcl except we turn on timestamp flag on the traffic 
# sources and print out the e2e delay at the sink
#
# Topology:
# h3 --\                      /-- h5
#      |-- n1 --- n0 --- n2-- |
...
foreach i {3 4} {
	...
	setflag timestamp true h$i/source
	set receiver [mkdir drcl.net.tool.Receiver h$dest_/receiver]
	connect -c $receiver/down@ -and h$dest_/csl/$port_@up
	setflag debug true $receiver
}
