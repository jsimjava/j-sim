...
# set up RED queue logic in the FIFO, $q_
set red_ [java::new drcl.inet.core.queue.RED $q_ ".avgq"]
$q_ setQLogic $red_
...
set bandwidth 1.0e4; #10Kbps
# Configure the bottleneck bandwidth and buffer size
! n3 setBandwidth 3 $bandwidth; # at interface 3
! n3 setBufferSize 3 6000; # ~10 packets at interface 3
[!!! [! n3/csl/q3 getQLogic]] setREDParam 0 $bandwidth 3000 1000 0.0 0.0
...
setflag garbagedisplay true n3/csl/*3 
#setflag trace true n3/csl/ni3/pull@ n3/csl/q3/up@,output@
puts "simulation begins..."	
set sim [attach_simulator event .]
$sim stop
setflag garbagedisplay true n3/csl/q3
run .../sink h0/source
