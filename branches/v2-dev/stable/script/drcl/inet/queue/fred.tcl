...
# set up FRED queue logic in the FIFO, $q_
set fred_ [java::new drcl.inet.core.queue.FRED $q_ ".avgq"]
$q_ setQLogic $fred_
...
! n3 setBufferSize 3 12000; # ~20 packets at interface 3
[!!! [! n3/csl/q3 getQLogic]] setREDParam 0 1.0e4 0.0 0.0 0.0 0.0
