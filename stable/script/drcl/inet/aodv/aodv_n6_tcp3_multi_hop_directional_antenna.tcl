...
#	puts "create node $i"
	...
	# create a switched beam antenna for the node and initialize the azimuth patter
	inject "create SwitchedBeam Antenna" phy/.antenna@
	inject "azimuthpatterns = azimuth-switchedbeam" phy/.antenna@
	# or using an adaptive array antenna
	#inject "create Adaptive Antenna" phy/.antenna@
	#inject "azimuthpatterns = azimuth-adaptive" phy/.antenna@
